...
ALTER TYPE match_stage ADD VALUE IF NOT EXISTS 'quarterfinal' AFTER 'qf';
...
BEGIN
  ...
  ELSIF p_stage = 'r16' THEN
    IF exact THEN RETURN 5; ELSIF correct_outcome THEN RETURN 3; ELSE RETURN 0; END IF;
  ELSIF p_stage = 'qf' THEN
    IF exact THEN RETURN 6; ELSIF correct_outcome THEN RETURN 4; ELSE RETURN 0; END IF;
  ELSIF p_stage = 'quarterfinal' THEN
    IF exact THEN RETURN 7; ELSIF correct_outcome THEN RETURN 5; ELSE RETURN 0; END IF;
  ELSIF p_stage IN ('sf','third') THEN
    IF exact THEN RETURN 8; ELSIF correct_outcome THEN RETURN 5; ELSE RETURN 0; END IF;
