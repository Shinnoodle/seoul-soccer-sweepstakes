...
- Name: bracket-standings-ui.spec.ts >> VM-trädet – grupptabeller >> poäng och statistik börjar på 0 när inga matcher är spelade
- Location: e2e/bracket-standings-ui.spec.ts:47:3
...
- generic [ref=e3]:
  ...
  - generic [ref=e15]:
    ...
    - button "Logga in" [ref=e18]
  - button "Inget konto? Skapa ett" [ref=e19]
```
